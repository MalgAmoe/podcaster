...
/// Preset names (1-3)
pub const EQ_PRESET_NAMES: [&str; 3] = ["Subtle", "Balanced", "Intense"];

/// EQ presets (1-3 scale) - applied as gain scaling for EnhanceEQ
pub const EQ_PRESETS: [EqPreset; 3] = [
    // 1: Subtle - minimal shaping
    EqPreset {
        lowmid_cut_db: -1.0,
