  ...
  return (
    <Show when={store.job}>
      <div class="flex flex-col items-center py-6">
        ...
        <h3 class="text-xl font-bold">{t("mooo")}</h3>
        <p class="text-base-content/60 text-sm mt-1">{t("audioReady")}</p>
        ...
        <div class="flex gap-3 mt-6">
          <button onClick={handleDownload} class="btn btn-primary gap-2" aria-label={t("downloadProcessedAudio")}>
          ...
          <button onClick={reset} class="btn btn-ghost" aria-label={t("uploadAnotherFile")}>
            {t("feedMeMore")}
          </button>
        </div>
      </div>
